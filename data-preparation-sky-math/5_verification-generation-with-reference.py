#!/usr/bin/env python3
"""Verification generator with ground truth access for reference-guided baseline"""
...
DATA_DIR = "/code/salsrahm-sandbox/data-reasoning/data-skymath/prepared_data/reduced_balanced_data/skywork_solutions_generated_eval_with_verification_reduced_balanced_split_by_solution.jsonl"
OUTPUT_DIR = "/code/salsrahm-sandbox/data-reasoning/data-skymath/prepared_data/reduced_balanced_data/with_reference_verification/part-1-done-verification/skywork_verifications_with_reference_eval.jsonl"

DATASET_TYPE = "VERIFICATION"


VERIFICATION_PROMPT = r"""You are a math teacher grading student work. Your task is to verify the student's solution step by step, checking if it leads to the expected answer and identify any errors. For each step, provide your analysis followed by a verdict. Use the Expected Answer to help determine if the student's work is correct.
...
Expected Answer: __EXPECTED_ANSWER_PLACEHOLDER__
...
ENDPOINT = "http://salsrahm-ag5-eval2-1752996861-router.default.svc.cluster.local:8000/v1"
